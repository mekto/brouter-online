        ...
        <div className="inner">
          <div className="flex s-b">
            ...
            <div className="actions">
              <a onClick={()=>{ actions.fitRoute(route.id); }}><SVGImport src={require('../../svg/expand.svg')}/></a>
              <a onClick={()=>{ actions.toggleRouteLock(route.id); }} className={route.locked && 'active'}><SVGImport src={require('../../svg/thumb-tack.svg')}/></a>
